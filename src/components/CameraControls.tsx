    ...
    <div className="flex flex-row gap-16 p-2 rounded-[75px]">
      <Button onClick={onCloseClick}>
        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M24.4583 2.45038L22.0496 0.041626L12.5 9.59121L2.95042 0.041626L0.541672 2.45038L10.0913 12L0.541672 21.5495L2.95042 23.9583L12.5 14.4087L22.0496 23.9583L24.4583 21.5495L14.9088 12L24.4583 2.45038Z" fill="#4ade80"/>
        </svg>
      </Button>
      <Button>
